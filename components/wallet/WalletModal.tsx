...
import { useWallet, groupAndSortWallets, isInstallRequired, WalletReadyState } from '@aptos-labs/wallet-adapter-react'
import { useContext, createContext, useState, useContext as useCtx, ReactNode } from 'react'
import styles from './WalletModal.module.css'

// Modal open/close state — separate from wallet state
  ...
  return (
    <div className={styles.overlay} onClick={close}>
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        {/* Aptos Connect — social login (Google/Apple) */}
