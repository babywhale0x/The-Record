  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const articleContent = JSON.stringify({
        ...
        priceView: Math.round(parseFloat(form.priceView) * 10000),
        priceCite: Math.round(parseFloat(form.priceCite) * 10000),
        priceLicense: Math.round(parseFloat(form.priceLicense) * 10000),
